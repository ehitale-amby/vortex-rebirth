...
smd(
  ...
  // Download View Once Message Command (Super Rude)
cmd(
    {
      pattern: "vv",
      alias: ["viewonce", "retrive"],
      desc: "Download a ViewOnce message. 🧐",
      category: "whatsapp",
      use: "<query>",
      react: "👀",
      filename: __filename,
      ...
      try {
        ...
        if (!viewOnceMessage) {
          return message.reply(
            "😡 *" +
              Config.botname +
              "* says:\n_Uhh, you absolute fool! Reply to a ViewOnce message instead of wasting my time!_ 🤦‍♂️"
          );
        }
        ...
        const viewOnceMessageKey = {
          ...
          message: {
            conversation:
              "```[💀 VIEWONCE CRACKED & STOLEN! 100% SUCCESS]```",
          },
        };
        ...
        await message.bot.sendMessage(
          message.jid,
          {
            ...
            caption:
              "🔥 *" +
              Config.botname +
              "* has exposed this so-called 'ViewOnce' garbage. Next time, don't try to hide things from me, weakling. \n\n⚡ *Powered by Vortex Rebirth* ⚡",
          },
          {
