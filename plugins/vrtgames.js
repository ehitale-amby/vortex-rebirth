      ...
      try {
        ...
        if (_0x2bfba9 === "end" && _0x44b37a) {
          if (_0xc06dac) {
            ...
            return await _0x435f9e.reply("🔴 *_Number Guessing Game ended. Try again later, loser!_* 😏");
          } else {
            return await _0x435f9e.reply("😒 *_You're not even the player in this game. Who invited you?_*");
          }
        } else if (_0x2bfba9 === "end" && !_0x44b37a) {
          return await _0x435f9e.reply(
            "🙄 *_Hey " + (_0x435f9e.senderName || "dummy") + ", There's no game running yet. Are you hallucinating?_*"
          );
        }
  
        if (_0x44b37a && _0x44b37a.status) {
          return await _0x435f9e.reply(
            "⚠️ *_A game is already in progress here. Can't handle one game at a time?_* 😏\n" +
            "🔹 *To End the Game:*  `" + prefix + "guess end`"
          );
        }
        ...
        if (_0x2bfba9.includes("easy")) {
          ...
          return await _0x435f9e.send(
            ...
            "🤡 *_Seriously? Choose a valid mode first!_* 🤡\n\n" +
            "📌 *Available Modes:*\n" +
            "   ▢ *Easy*   (1 - 100)\n" +
            "   ▢ *Medium* (1 - 1000)\n" +
            "   ▢ *Hard*   (1 - 10000)\n" +
        ...
        await _0x435f9e.reply(
          logoName +
          "\n 🕹️ *𝗡𝘂𝗺𝗯𝗲𝗿 𝗚𝘂𝗲𝘀𝘀𝗶𝗻𝗴 𝗚𝗮𝗺𝗲 𝗦𝘁𝗮𝗿𝘁𝗲𝗱!* 🕹️\n\n" +
          "🟢 *Selected Mode:* _" + _0x44b37a.mode + "_\n\n" +
          "💡 *_I'm thinking of a number between " +
          (_0x44b37a.mode === "Easy"
            ? "1 and 100"
          ...
          "   ▢ Show me your brain power 🧠\n" +
          "   ▢ Let's see how many attempts you take! 😈"
        );
  
      } catch (_0x55d9e4) {
        await _0x435f9e.error("🔥 *ERROR:* " + _0x55d9e4 + "\n\nCommand: Guess", _0x55d9e4);
      }
    }
  );
...
const quotes = [
  "🔴 Connect Four? More like Connect Bore! Let's see if you can even keep up. 😏",
  "💀 Time to crush your weak strategy. Four-in-a-row? Easy win for me! 😂",
  "🎭 Let the battle of wits begin—though I doubt you have any. 🤡",
  "🧠 Outsmart me? Ha! You struggle to connect even two thoughts. 😆",
  "🤖 This game is about strategy... something you're clearly lacking. 🙄",
  "🔥 Connect Four: A game of skill... and you're about to get schooled. 👊",
  "😂 Four in a row? That’s the closest you'll get to an achievement. 🏆",
  "🤓 Unleash your so-called 'genius'—I’ll be here laughing at your moves. 😜",
  "💥 Drop the piece, take the L. That’s the real strategy here. 🤭",
  "💡 Every move counts… and yours are counting towards an embarrassing defeat. 🤣",
  "🏆 Prove your 'skills'—or just admit defeat now and save the humiliation. 😏",
  "⚠️ Warning: Playing against me may cause frustration and regret. 😈",
  "🎯 Easy to learn, impossible for you to master. Let's be real. 😆",
  "💀 First to connect four wins—so, basically, me. You're just a spectator. 😏",
  "🎮 Prepare for an epic beatdown in this so-called 'strategy' game. 🥱",
  "🥶 Ready to connect and lose? Because that’s the only thing you'll be winning. 😂",
  "👑 Who will be the Connect Four champion? Hint: Not you. 😎",
  "🛑 Strategize all you want—you're still gonna lose. Just accept it. 🤡",
  "🚨 Let the Connect Four destruction begin! Hope you like disappointment. 🤣",
  "💀 Connect Four: The ultimate test of skill... too bad you failed the entrance exam. 😂",
];
  ...
  smd(
    ...
    async (_0x211ed5) => {
      ...
      if (_0x20d34d && _0x20d34d.gameStatus) {
        return await _0x211ed5.send(
          "*💀 A game is already running in this chat.*\n*👿 Battle Between :- _@" +
            ...
            '_*\n\n_⚠️ If you, @{message.sender.split("@")[0]}, dare to play,_ \n_Then wipe this weak session with:_ {prefix}delcfg_',
          {
      ...
      try {
        ...
        await _0x211ed5.reply("💀 *Error:* " + _0x264edb);
      }
      if (_0x20d34d.gameStatus) {
        ...
        let _0x2d3c4c =
          "🔥 *𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙* 🔥\n   𝗖𝗼𝗻𝗻𝗲𝗰𝘁 𝗙𝗼𝘂𝗿 𝗦𝘁𝗮𝗿𝘁𝗲𝗱 🎮\n\n" +
          _0x364961 +
          " \n◣━━━━━━━━━━ ━━━━━━━━━━◢\n\n🎯 *Connect Four Session Live!* \n🏷️ *Room ID:* _cfg-" +
          _0x4f21cc.split("@")[0] +
          "_*\n\n💥 *Current Turn:* _@" +
          _0x20d34d.player1.split("@")[0] +
          "_*\n🔜 *Next Up:* _@" +
          ...
          ", try not to embarrass yourself._\n▶️ *Pick a column (1 - 7) and pray you survive.*\n\n💀 *Mission:* \n  - *Connect Four* colors in a row 🟡🔴\n  - Win *Horizontally, Vertically, or Diagonally* 🔥\n\n🎮 *Game On!* _" +
    ...
    async ({
      ...
      if (_0x202014) {
        if (
          ...
          await _0x28e18a(
            "💀 *Oi, " + _0x2c14e6 + "*! You're not even playing, so why the hell are you trying to delete MY game? 🤡 Go cry somewhere else. 🚮"
          );
        } else {
          delete astro_patch_cfg[_0xa871db];
          await _0x28e18a(
            "🔥 𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 🔥\n\n💥 *Connect Four Game Deleted* 💥\n\n*Room ID: _cfg-" +
              _0xa871db.split("@")[0] +
              "_*\n\n🗑️ *This pathetic game has been erased from existence. Now go touch some grass, loser.* 🌱💨"
          );
        }
      } else {
        await _0x28e18a(
          "🚨 𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 🚨\n\n🤡 *404 Game Not Found* 🤡\n\n📢 *Lemme guess... you’re trying to delete a game that DOESN’T even exist?* 💀\n\n*Go sit down before you embarrass yourself even more.* 🪑💨"
        );
      }
    }
  );
        ...
        try {
            ...
            return await _0xcabf04.bot.sendMessage(
              _0xcabf04.chat,
              {
                text:
                  ...
                  "* 🤡 What kind of braindead move was that? The line is FULL, genius. Try another one before I lose all faith in humanity. 💀",
          ...
          if (!_0x1521ca) {
            let _0x2c98f1 =
              ...
              "_*\n\n🎭 *Try not to embarrass yourself with this turn, weakling.*\n📌 _Enter a number between *1* and *7* or just quit if you suck._\n\n🗿 *Game Wisdom:* _" +
              quotes[Math.floor(Math.random() * quotes.length)] +
              "_";
            ...
            return await _0xcabf04.send(
              "🔥 𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 🔥\n\n🏆 *𝗖𝗼𝗻𝗻𝗲𝗰𝘁 𝗙𝗼𝘂𝗿 Game Over* 🏆\n\n🎉 *𝙒𝙞𝙣𝙣𝙚𝙧: _@" +
                ...
                "\n🔥 *Congrats @" +
                _0x1521ca.split("@")[0] +
                ", you finally proved you have a brain.* 🔥\n🧠 *You won in* '" +
                _0x47f35e.attempts[_0x1521ca] +
                "' *turns. Took you long enough.*\n\n💀 *Game over. Now get out of my sight.*\n💾 _Type_ *.Cfg* _to start a new game, if you dare._",
              {
                mentions: [_0x47f35e.player1, _0x47f35e.player2],
              }
            );
          ...
          return await console.log("🔥 Connect Four Error: ", _0x30983e);
        }
      }
    }
  );
  ...
  let captions = {
    ...
    winReward: 2000,
    onStart:
      "⚠️ *𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 - Capital Game Started* ⚠️\n👤 *Player:* _@$player_\n🎯 *Task:* _Tell me the capital of *$country*, and don’t embarrass yourself._\n\n⏳ _You got *$waitTime* seconds, so hurry up._",
    onTimeOut:
      "❌ *𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 - Game Over* ❌\n\n😒 *Player:* _@$player_\n🚫 *Reason:* _Too slow, loser. You ran out of time._\n\n💡 *Answer:*\n_The capital of *$country* is *$capital*._\n\n_Better luck next time, if your brain starts working._",
    onLimitEnd:
      "💀 *𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 - Game Over* 💀\n\n🤡 *Player:* _@$player_\n🗑️ *Reason:* _Pathetic! You failed after 3 attempts._\n\n💡 *Answer:*\n_The capital of *$country* is *$capital*._\n\n_Why even try? Go touch some grass._",
    onWrongAns:
      "🤦‍♂️ *𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 - Wrong Answer* 🤦‍♂️\n\n👤 *Player:* _@$player_\n❌ _WRONG! Even a 5-year-old knows this._\n\n⚠️ _You got *$attempt* more attempt(s) left, try harder._\n⏳ _Clock’s ticking, you have *$waitTime* seconds._",
    onWinGame:
      "🎉 *𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 - WINNER!* 🎉\n\n👑 *Player:* _@$player_\n✅ _Finally! You got it right._\n🏆 _The capital of *$country* is *$capital*._\n🎯 _Answered in *$attempt* attempt(s)!_\n💰 _$amount cash has been added to your wallet._\n\n_Don’t get too cocky, it was just a game._",
  };  
...
class HiddenCardGame {
  ...
  makeMove(_0xa4cc81, _0xb34f99) {
    ...
    if (_0xa4cc81 !== this.currentPlayer) {
      return "*_Oi dumbass, wait your turn!_🤡*";
    }
    ...
    if (this.isValidMove(_0x52c4bf)) {
      if (_0x52c4bf === this.hiddenCardIndex) {
        ...
        return (
          ...
          "_*\n\n" +
          _0x5b6677 +
          " \n\n🔱 *_Well well, look who got lucky..._* \n  💰 *_@" +
          _0xa4cc81.split("@")[0] +
          " flexing with " +
          this.attempts[this.currentPlayer] +
          " attempts._*\n\n🔚 *𝗚𝗮𝗺𝗲 𝗦𝗲𝘀𝘀𝗶𝗼𝗻 𝗘𝗻𝗱𝗲𝗱* 🔚\n\n🚀 *_.hcg to play again... If you dare_* 😈\n\n```\t 𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗯𝘆 𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 ```\n"
        );
      } else {
        this.board[Math.floor(_0x52c4bf / this.row)][_0x52c4bf % this.column] =
          "🟦";
        ...
        if (_0x3d1f61 === "continue") {
          ...
          return (
            hcg_Logo +
            "  🎭 *𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 - 𝗤𝗨𝗘𝗘𝗡 𝗖𝗔𝗥𝗗 𝗚𝗔𝗠𝗘* 🎭`\n\n" +
            this.displayBoard() +
            "\n\n👀 *Current Turn:* @" +
            ...
            "_\n\n\n 🤡 *_Hurry up and stop wasting oxygen._*\n 🔢 _Pick a number between *1* and *" +
            this.row * this.column +
            "*... Try not to mess up._\n\n```\t 𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗯𝘆 𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 ```"
          );
        } else {
          this.gameStatus = false;
          return "🚨 *𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 - 𝗚𝗔𝗠𝗘 𝗢𝗩𝗘𝗥* 🚨\n\n💀 *_Pathetic! The hidden card remains hidden. Game over, losers._*\n\n```\t 𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗯𝘆 𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 ```";
        }
      }
    } else {
      return (
        "🚫 *𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 - 𝗜𝗡𝗩𝗔𝗟𝗜𝗗 𝗠𝗢𝗩𝗘* 🚫\n\n🤡 *Oi @*" +
        this.currentPlayer.split("@")[0] +
        "_ (•̪●), you blind?*\n❌ _That number is INVALID or already used!_\n🔢 _Pick a number between *1* and *" +
        this.row * this.column +
        "*... Don’t screw up again._\n\n```\t Powered by 𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙 ```"
      );
    }
  }
  makeMove(_0xa4cc81, _0xb34f99) {
