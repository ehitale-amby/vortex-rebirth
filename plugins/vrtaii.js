...
smd(
    ...
    async (_0x1c0160, _0x482db1) => {
      try {
        return _0x1c0160.reply_text(await aiResponce(_0x1c0160, "chat", _0x482db1));
      } catch (_0x4adf95) {
    ...
    async (_0x5cb388, _0x302ad5) => {
      try {
        try {
          ...
          if (!_0x557719) {
            return _0x5cb388.reply_text("Provide me a query, like 'Who is mx' 🤦‍♂️");
          }
          ...
          if (_0x14c9d6 && _0x14c9d6.status && _0x14c9d6.result) {
            return await _0x5cb388.reply_text(_0x14c9d6.result);
          }
        } catch {}
        if (
          ...
          return _0x5cb388.reply_text(
            "```You Don't Have an OPENAI API KEY! \nCreate one from here: \nhttps://platform.openai.com/account/api-keys\nAnd Set the Key in Heroku OPENAI_API_KEY Var``` 🤦‍♂️"
          );
        }
        if (!_0x302ad5) {
          return _0x5cb388.reply_text(
            "Hey " + _0x5cb388.senderName + ", How are you doing these days? 🤔"
          );
        }
        ...
        await _0x5cb388.error(
          _0x2ef914 + "\n\ncommand: gpt",
          _0x2ef914,
          "*_no response from chatgpt, sorry!!_* 😤"
        );
        await _0x5cb388.react("😡");
      }
    }
  );
  ...
  smd(
    ...
    async (_0x21be87, _0x17d498) => {
      try {
        if (!_0x17d498) {
          return await _0x21be87.reply("*Give me a query for DALL-E response, you lazy idiot* 😤");
        }
        const _0x27bd9a =
        ...
        if (
          ...
          return _0x21be87.reply(
            "```You don't have an OPENAI API KEY 😤\nCreate one here: \nhttps://platform.openai.com/account/api-keys\nAnd Set the Key in Heroku OPENAI_API_KEY Var```"
          );
        }
        return await _0x21be87.bot.sendMessage(_0x21be87.chat, {
          image: {
        ...
        await _0x21be87.error(
          _0x25b4b9 + "\n\ncommand: dalle",
          _0x25b4b9,
          "*_No response from DALL-E AI, sorry!! You're useless.* 😒"
        );
        await _0x21be87.react("😡");
      }
    }
  );
  ...
  cmd(
    ...
    async (_0x4e4351) => {
      try {
        ...
        await _0x4e4351.send(util.format(_0x536aa6), {}, "vrt", _0x680da4);
      } catch (_0x2ee8cc) {
  ...
  cmd(
    ...
    async (_0xbda24) => {
      try {
        ...
        await _0xbda24.send(util.format(_0x3e1ea8.url), {}, "vrt", _0x7d6de1);
      } catch (_0x1a2f02) {
    ...
    async (_0x397531) => {
      try {
        ...
        return await _0x397531.bot.sendUi(_0x397531.jid, {
          caption: `_VRT isn't for the weak._ 💀\n\n${_0x53eb40}\n\n*Powered by Vortex Rebirth*`
        });
      } catch (error) {
        await _0x397531.error(error, "*_I'm too busy to give a damn about this, move on!* 😤");
      }
    }
  );
  ...
  smd(
    ...
    async (_0x51c639) => {
      try {
              ...
              Object.keys(_0x52bb92.times)
                .map(
                  (_0x1a945a) =>
                    ...
                    ": " +
                    (
                      (_0x52bb92.times[_0x1a945a] * 100) / _0x52bb92.total
                    ).toFixed(2) +
                    "%"
                )
                .join("\n      ") +
        ...
        return await _0x51c639.send(respon + "\n*Powered by Vortex Rebirth* 💀", {}, "", _0x51c639);
      } catch (error) {
        await _0x51c639.error(error, "*_Error with server info, move along!* 😤");
      }
    }
  );
      ...
      try {
        ...
        if (!_0x14810d) {
          return await _0x165087.reply(
            "*Need help, huh? Here's the format:* `advt 234906652xx,Your_text_here` 😎"
          );
        }
        const _0x94ba67 = _0x14810d.indexOf(",");
        if (_0x94ba67 === -1) {
          return await _0x165087.send(
            "*You call this advertising? Use a comma to separate the number and message. Dumbass.* 😤"
          );
        }
        ...
        if (!_0xd9b857.includes("x")) {
          return _0x165087.send(
            "*Did you forget the 'x'? Use something like `234906652xx`.* 😒"
          );
        }
        await _0x165087.send(
          "*Sending your message to the number range... Wait for it.* 😏"
        );
        ...
        if (_0x43415b == 1) {
          ...
          return await _0x165087.send("*Only 3(x) are allowed. Try again.* 💥");
        }
        let _0x1e111b = 0;
        let _0x5c0975 = "";
        var _0x5b9d27 = "";
        ...
        return await _0x165087.send(
          "*Advertisement sent, you lucky idiot.* 😈\n\n" +
        ...
        await _0x165087.error(
          _0xfcb50a + "\n\ncommand: advt",
          _0xfcb50a,
          "*Server messed up, try again later... Dumbass.* 😤"
        );
      }
    }
  );
    ...
    async (_0x2acf30) => {
      try {
        if (
          ...
          if (
            _0x2acf30.reply_text.includes("VRT • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            _0x2dfb59[0].includes("VRT • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
  ...
  smd(
    ...
    async (_0x1a01af, _0x1ac85a) => {
      try {
        ...
        await _0x1a01af.error(
          err + "\n\ncommand: " + _0x1ac85a,
          err,
          "*_Can't process the text-to-speech request, idiot!_* 😤"
        );
      }
    }
  );
