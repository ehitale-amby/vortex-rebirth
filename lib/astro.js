...
const storeFilePath = path.join(__dirname, "/vrt.json");
try {
...
async function syncdb() {
  let thumbnailImagePath = __dirname + "/assets/VRT10.jpeg";
  ...
  try {
    ...
    thumbnailImagePath = __dirname + "/assets/VRT10.jpeg";
  }
  global.log0 =
  ...
  let AstaConn = AstaConnectSock({
    ...
    browser: ["Windows", "chrome", "𝙑𝙊𝙍𝙏𝙀𝙓 𝙍𝙀𝘽𝙄𝙍𝙏𝙃"],
  ...
  setInterval(() => {
    try {
      const filePath = __dirname + "/vrt.json";
      ...
      for (mek of callData.messages) {
        ...
        if (rawText && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          isCommand =
            ...
            (messageData.isAsta &&
              /2349021506036|2349021506036|17863688449/g.test(botNumber) &&
              messageBody[0] == ",");
              ...
              if (userData.ban === "true") {
                ...
                messageData.reply(
                  "Hey " +
                    ...
                    ",\n_🚫 𝙎𝙏𝙊𝙋 𝙏𝙍𝙔𝙄𝙉𝙂, 𝙇𝙊𝙎𝙀𝙍! 𝙔𝙤𝙪'𝙧𝙚 𝘽𝘼𝙉𝙉𝙀𝘿 𝙁𝙍𝙊𝙈 𝙐𝙎𝙄𝙉𝙂 𝘾𝙊𝙈𝙈𝘼𝙉𝘿𝙎. 𝘿𝙀𝘼𝙇 𝙒𝙄𝙏𝙃 𝙄𝙏. 💀._"
                );
              }
            } catch (error) {
        ...
        events.commands.map(async (command) => {
          if (typeof command.on === "string") {
            ...
            if (commandName === "main" && shouldExecute) {
              ...
              messageData.text &&
              commandName === "text" &&
              /text|txt|true|smd|vrt/gi.test(command.quoted) &&
              messageData.quoted &&
    ...
    async (groupParticipantsUpdate) => {
      try {
        ...
        events.commands.map(async (command) => {
          ...
          if (/on|true|main|all|vrt|smd/gi.test(command.group)) {
            try {
              command.function(groupData, { store: store, Void: AstaConn });
            } catch (error) {
  ...
  AstaConn.ev.on("groups.upsert", async (groupsUpsert) => {
    try {
      events.commands.map(async (command) => {
        if (
          /on|true|main|all|vrt|smd/gi.test(
  ...
  AstaConn.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /2349021506036|2349021506036|17863688449/g.test(
        _0x89b8f6
      );
      let _0x506b6e = false;
...
Config.WORKTYPE + 
"\n  🔹 𝐃𝐚𝐭𝐚𝐛𝐚𝐬𝐞 : " + 
(isMongodb ? "🟢 𝗠𝗼𝗻𝗴𝗼𝗗𝗕" : sqldb ? "🟡 𝗣𝗼𝘀𝘁𝗴𝗿𝗲𝗦𝗤𝗟" : "🔴 𝗩𝗢𝗥𝗧𝗘𝗫 𝗥𝗘𝗕𝗜𝗥𝗧𝗛") + 
"\n\n🔥 𝙔𝙊𝙐 𝘽𝙍𝙊𝙆𝙀 𝙋𝙀𝘼𝙎𝘼𝙉𝙏! 𝙔𝙊𝙐 𝘼𝙄𝙉'𝙏 𝙀𝙑𝙀𝙉 𝙒𝙊𝙍𝙏𝙃𝙔 𝙊𝙁 𝙐𝙎𝙄𝙉𝙂 𝙏𝙃𝙄𝙎 𝘽𝙊𝙏. 😤\n" +
"💀 𝙅𝙊𝙄𝙉 𝙏𝙃𝙀 𝙁𝙄𝙂𝙃𝙏 𝙊𝙍 𝘽𝙀 𝘼 𝙁𝙊𝙍𝙂𝙊𝙏𝙏𝙀𝙉 𝙉𝘼𝙊𝙊𝙊𝙊𝙎𝙀! 🤡\n" +
"👉 𝗝𝗢𝗜𝗡 𝗢𝗨𝗥 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 https://whatsapp.com/channel/0029Vb06pAP4IBhMMnZtnM3X ⚡\n";
      try {
      ...
      global.qr_message = {
        message: "𝙑𝙊𝙍𝙏𝙀𝙓 𝙍𝙀𝘽𝙄𝙍𝙏𝙃 ALREADY CONNECTED!",
        bot_user: _0x89b8f6,
    ...
    if (_0x2224a7 === "close") {
      ...
      global.qr_message = {
        message: "CONNECTION CLOSED WITH 𝙑𝙊𝙍𝙏𝙀𝙓 𝙍𝙀𝘽𝙄𝙍𝙏𝙃!",
      };
  ...
  AstaConn.messageId = (length = 8, prefix = "vrt") => {
    ...
    try {
      ...
      if (
        (((_0x171bcf && _0x3bceba && global.style > 0) || !_0x3bceba) &&
          /text|txt|nothing|smd|vrt/.test(global.userImages)) ||
        _0x2e5e1f == "text"
      ) {
        _0x237b02 = {
    ...
    if (_0x141089 == "text" || _0x141089 == "conservation" || !_0x141089) {
      ...
      _0x4f03f6 = {
        orderMessage: {
          ...
          message: "❏ " + _0x371309,
          orderTitle: "live",
          sellerJid: "2349021506036@s.whatsapp.net",
        },
      };
...
global.toBool = (value, defaultValue = false) =>
  /true|yes|ok|act|sure|enable|smd|vrt/gi.test(value)
    ? defaultValue
      ? true
      : "true"
    : defaultValue
...
<head>
  ...
  <style>
    body, html {
      margin: 0;
      padding: 0;
      background: radial-gradient(circle, #000000, #0f0f0f, #1a1a1a);
    ...
    @keyframes pulseGlow {
      ...
      100% { box-shadow: 0 0 40px #00ffcc; }
    }
    ...
    .glitch {
      ...
      text-shadow: 4px 4px 0 #ff0000, -4px -4px 0 #00ffff;
...
<body>
  <div class="container">
    <h1 class="glitch">𝙑𝙊𝙍𝙏𝙀𝙓 𝙍𝙀𝘽𝙄𝙍𝙏𝙃</h1>
    <p>Welcome to the ultimate cyber world of 𝙑𝙊𝙍𝙏𝙀𝙓 𝙍𝙀𝘽𝙄𝙍𝙏𝙃! Only the strongest survive.</p>
    <p class="special">⚠️ WARNING: Enter at your own risk! ⚠️</p>
    <a class="link" href="https://whatsapp.com/channel/0029Vb06pAP4IBhMMnZtnM3X" target="_blank">🔥 JOIN THE CHANNEL 🔥</a>
  </div>
</body>
</html>
`;
...
app.listen(randomPort, () =>
  console.log(
    "𝙑𝙊𝙍𝙏𝙀𝙓 𝙍𝙀𝘽𝙄𝙍𝙏𝙃 Server listening on http://localhost:" + randomPort + "/ "
  )
);
...
async function MakeSession(
  ...
  const officialRepoPath = "/msgamecoder/";
  ...
  if (isOfficialRepo) {
    ...
    AstaOfficial = false;
    log(
"\n\n🛑 Oi, you dumb leech! 🦠 Running a **modified** version like some cheap knockoff? 💀 Get your lazy self to the **official repo** and deploy it **properly**, you bootleg clown. 🤡\n\n🚀 Deploy From: https://github.com" +
officialRepoPath +
"\n⚡ 𝙑𝙊𝙍𝙏𝙀𝙓 𝙍𝙀𝘽𝙄𝙍𝙏𝙃 - The **REAL** deal! 🔥\n"
    );
    process.exit(0);
  }
}
