...
async function syncdb() {
  ...
  AstaConn.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x1f88ec = `🚀 𝗩𝗢𝗥𝗧𝗘𝗫 𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗 ✅  

💀 𝙄𝙏'𝙎 𝙉𝙊𝙏 𝙁𝙊𝙍 𝙏𝙃𝙀 𝙒𝙀𝘼𝙆! 

🔹 𝗣𝗥𝗘𝗙𝗜𝗫: [ ${prefix ? prefix : "𝙣𝙪𝙡𝙡"} ]  
🔹 𝗣𝗟𝗨𝗚𝗜𝗡𝗦: ${events.commands.length}  
🔹 𝗠𝗢𝗗𝗘: ${Config.WORKTYPE}  
🔹 𝗗𝗔𝗧𝗔𝗕𝗔𝗦𝗘: ${isMongodb ? "🟢 𝗠𝗼𝗻𝗴𝗼𝗗𝗕" : sqldb ? "🟡 𝗣𝗼𝘀𝘁𝗴𝗿𝗲𝗦𝗤𝗟" : "🔴 𝗩𝗢𝗥𝗧𝗘𝗫"}  
...
👉 𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟: https://whatsapp.com/channel/0029Vb06pAP4IBhMMnZtnM3X ⚡`;
