  ...
  return new Promise((_0x4ebaf9, _0x4bc015) => {
    ...
    axios({
      ...
      axios({
        ...
        _0x4ebaf9({
          status: true,
          "message": "⚡ 𝘾𝙧𝙚𝙖𝙩𝙚𝙙 𝘽𝙮 𝙑𝙊𝙍𝙏𝙀𝙓 𝙍𝙀𝘽𝙄𝙍𝙏𝙃",
          result: _0x2c0ca3
        });
      }).catch(_0x4bc015);
    }).catch(_0x4bc015);
...
if (fs.existsSync("./source/" + Config.LANG + ".json")) {
  ...
  var json = JSON.parse(fs.readFileSync("./source/whatsapp.json"));
}
...
function botpic() {
  return new Promise((_0x2b19e2, _0x596d7c) => {
    ...
    let _0x255444 = ["" + _0x169afc.pic1, "" + _0x169afc.pic2, "" + _0x169afc.pic3, "" + _0x169afc.pic4, "" + _0x169afc.pic5, "" + _0x169afc.pic6, "" + _0x169afc.pic7, "" + _0x169afc.pic8, "" + _0x169afc.pic9, "" + _0x169afc.pic10];
