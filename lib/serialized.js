...
exports.GIFBufferToVideoBuffer = async (_0x178b96) => {
  ...
  await sleep(6000);
  var _0x1e527 = await fs.readFileSync("./" + _0x5e8ed0 + ".gif");
  Promise.all([
...
exports.callsg = async (_0x235969, _0x426e27) => {
  if (global.AstaOfficial && global.AstaOfficial === "yes") {
    ...
    _0x642975.send = async (
      _0x23e41c,
      _0x4e7834 = {
        author: "𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙",
      },
      _0x1c62b5 = "𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙",
      _0x244af8 = "",
  ...
  try {
    ...
    _0x22cff2.getpp = async (_0x577c8f = _0x22cff2.user) => {
      try {
        ...
        return "https://i.ibb.co/TMDx1Xwg/VRT4.jpg";
      }
    };
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("𝕍𝕠𝕣𝕥𝕖𝕩 ℝ𝕖𝕓𝕚𝕣𝕥𝕙");
    ...
    if (_0x1d4327) {
      ...
      if (_0x2d6cd0.quoted.message) {
        ...
        _0x2d6cd0.quoted.isBaileys = _0x2d6cd0.quoted.isBot =
          ...
          _0x2d6cd0.quoted.id?.startsWith("VRT") ||
  ...
  _0x2d6cd0.getpp = async (_0x267509 = _0x2d6cd0.sender) => {
    try {
      ...
      return "https://i.ibb.co/y7pcntR/VRT3.jpg";
    }
  };
